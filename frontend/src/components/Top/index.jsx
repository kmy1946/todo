  ...
  return (
    <Container maxWidth="xs">
      <Box display="flex" justifyContent="space-between" mt={4} mb={4}>
        ...
        <Button variant="contained" onClick={handleCreate} style={{color:'white', backgroundColor: '#55aaff'}}>作成</Button>
      </Box>
      <FormGroup>
          ...
          return (
            <Box key={index} display="flex" justifyContent="space-between" mb={1}>
              <FormControlLabel
                ...
                label={todo.name}
              />
              <Button variant="contained" data-id={todo.id} onClick={handleDelete} style={{color:'white', backgroundColor: '#ff4b4b'}}>削除</Button>
            </Box>
          )
        })}
      </FormGroup>
